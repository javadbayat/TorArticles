...
6. حال باید پروکسی Tor را در تلگرام تنظیم کنید. برای این کار تلگرام را باز کنید و به بخش تنظیمات بروید. سپس روی گزینه «Advanced» کلیک کنید.
7. سپس روی گزینه «Connection type» کلیک کنید.
8. پنجره ای با عنوان «Proxy settings» باز می شود. در این پنجره روی دکمه «Add proxy» کلیک کنید تا یک پروکسی جدید اضافه کنید.
